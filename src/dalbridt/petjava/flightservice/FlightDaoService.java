...
public class FlightDaoService {
    ...
    private final String addNewFlightQuery = "insert into flights (flight_no, scheduled_departure, scheduled_arrival, departure_airport,arrival_airport, status, aircraft_code, actual_departure, actual_arrival, is_active)\n" + "values (?, ?, ?, \n" + "?, ?, ?, ?, ?, ?, ?)";
